...
@endsection
@php
    $sexChecked = old('sex') ? old('sex') : $customer->sex;
@endphp
@section('content')
                ...
                <form class="forms-sample" method="POST" action="{{route('customer.update', $customer->id)}}">
                    ...
                    <div class="row">
                        <div class="form-group col-md-4">
                            <label class="col-form-label">Tên khách hàng<span class="text-danger">*</span></label>
                            <input type="text" class="form-control" name="fullname" value="{{$customer->fullname}}" autocomplete="off" maxlength="255">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <input type="text" class="form-control" name="phone" maxlength="20" value="{{$customer->phone}}">
                            @if ($errors->has('phone'))
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <div class="input-group date datepicker-single">
                                <input maxlength="50" type="text"
                                       ...
                                       value="{{!empty($customer->birtday) ? date('d-m-Y', strtotime($customer->birtday)) : date('d-m-Y')}}"
                                       autocomplete="off">
