...
@endsection
@php
    $sexChecked = old('sex') ? old('sex') : $staff->sex;
@endphp
@section('content')
                ...
                <form class="forms-sample" method="POST" action="{{route('staff.update', $staff->id)}}">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="code" value="{{$staff->code}}" autocomplete="off" maxlength="50" readonly>
                            @if ($errors->has('code'))
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="fullname" value="{{$staff->fullname}}" autocomplete="off" maxlength="255">
                        ...
                        <div class="form-group col-md-3">
                            ...
                            <input type="text" class="form-control" name="phone" maxlength="20" value="{{$staff->phone}}">
                            @if ($errors->has('phone'))
