<script src="{{asset('template/statics/html5shiv.js')}}"></script>
<script src="{{asset('template/statics/respond.min.js')}}"></script>
<meta charset="utf-8">
...
<link rel="stylesheet" type="text/css" href="{{asset('template/assets/icon/ion-icon/css/ionicons.min.css')}}">
...
<link rel="stylesheet" type="text/css" href="{{asset('template/assets/pages/prism/prism.css')}}">
